...
exp = data['exp'].values.reshape(-1, 1)
...
x_train, x_test, y_train, y_test = ms.train_test_split( exp, salaries, test_size = 1/3, random_state= 0)
...
# Graph
plt.scatter(exp, salaries, color='r')
